...
final class DateViewCell: UICollectionViewCell {
    ...
    var isPriviousDate: Bool = false {
        didSet{
            if !isOn {
                containerView.backgroundColor = isPriviousDate ? format.dayBackgroundDisabledColor : format.dayBackgroundColor
            }
        }
    }
